# -*- coding: utf-8 -*-
"""
Created on Wed May 23 09:58:37 2018
...
"""
First, let's download the data set, import TensorFlow and other utilities, 
and load the data into a pandas DataFrame. Note that this data is a sample 
of the original MNIST training data; we've taken 20000 rows at random.
For this exercise, I downloaded the mnist_train_small.csv from googleapi storage and stored it in my local system 
...
##  io.open("/tmp/mnist_train_small.csv", "r"),
    io.open("C:/Users/Deepa Manu/Google MLCC/mnist_train_small.csv", "r"),
    sep=",",
    header=None)


#mnist_dataframe = pd.read_csv('C:/Users/Deepa Manu/Google MLCC/mnist_train_small.csv')
...
mnist_test_dataframe = pd.read_csv(
 # io.open("/tmp/mnist_test.csv", "r"),
   io.open("C:/Users/Deepa Manu/Google MLCC/mnist_test.csv", "r"),
  sep=",",
  header=None)
